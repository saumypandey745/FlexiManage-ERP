...
export class OrganizationController {
  ...
  @Patch('settings')
  @ApiOperation({ summary: 'Update Organization Settings (Timezone, Currency)' })
  async updateSettings(@CurrentUser() user: any, @Body() dto: OrganizationSettingsDto) {
  ...
  async updateProfile(@CurrentUser() user: any, @Body() dto: BusinessProfileDto) {
  ...
  async updateBranch(@CurrentUser() user: any, @Param('id') id: string, @Body() dto: UpdateBranchDto) {
  ...
  async updateDepartment(@CurrentUser() user: any, @Param('id') id: string, @Body() dto: UpdateDepartmentDto) {
  ...
  async updateTeam(@CurrentUser() user: any, @Param('id') id: string, @Body() dto: UpdateTeamDto) {
