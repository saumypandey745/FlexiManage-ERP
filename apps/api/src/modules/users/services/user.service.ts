...
export class UserService {
  ...
  async updateUser(tenantId: string, id: string, actionUserId: string, dto: UpdateUserDto) {
  ...
  async changeStatus(tenantId: string, id: string, actionUserId: string, status: UserStatus) {
