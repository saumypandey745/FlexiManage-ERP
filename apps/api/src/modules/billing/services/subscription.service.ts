...
export class SubscriptionService {
  ...
  async createSubscription(tenantId: string, userId: string, dto: CreateSubscriptionDto) {
  ...
  async updateSubscription(tenantId: string, subscriptionId: string, userId: string, dto: UpdateSubscriptionDto) {
  ...
  async cancelSubscription(tenantId: string, subscriptionId: string, userId: string) {
