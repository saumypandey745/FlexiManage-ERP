...
export class AiVectorRepository {
  ...
  async saveDocument(tenantId: string, dto: EmbedDocumentDto): Promise<AiDocument> {
  ...
  async saveEmbedding(tenantId: string, documentId: string, content: string, chunkIndex: number, vectorArray: number[]) {
