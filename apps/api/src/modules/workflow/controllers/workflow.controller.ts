...
export class WorkflowController {
  ...
  addNode(@Req() req: any, @Param('id') id: string, @Body() dto: CreateWorkflowNodeDto) {
  ...
  addEdge(@Req() req: any, @Param('id') id: string, @Body() dto: CreateWorkflowEdgeDto) {
  ...
  publish(@Req() req: any, @Param('id') id: string, @Query('version') version: string) {
  ...
  run(@Req() req: any, @Param('id') id: string, @Body() dto: TriggerWorkflowDto) {
