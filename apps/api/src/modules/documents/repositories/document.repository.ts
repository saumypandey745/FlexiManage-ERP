...
export class DocumentRepository {
  ...
  async logAudit(tenantId: string, documentId: string, userId: string, action: string, details?: any) {
  ...
  // ===================== SHARING =====================
  async shareDocument(tenantId: string, documentId: string, permission: DocumentPermissionType, sharedWithId?: string, sharedWithEmail?: string) {
