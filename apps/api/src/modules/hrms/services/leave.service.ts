...
export class LeaveService {
  ...
  async create(tenantId: string, actionUserId: string, employeeId: string, dto: CreateLeaveDto) {
  ...
  async updateStatus(tenantId: string, id: string, actionUserId: string, dto: ApproveLeaveDto) {
