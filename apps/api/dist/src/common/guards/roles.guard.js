...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        const requiredRoles = this.reflector.getAllAndOverride(auth_decorators_1.ROLES_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
        const requiredPermissions = this.reflector.getAllAndOverride(auth_decorators_1.PERMISSIONS_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
